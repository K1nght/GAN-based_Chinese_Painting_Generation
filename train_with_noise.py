...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs*opt.n_epochs_D + opt.n_epochs_decay + 1):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
